...
bullet_public = json.loads( "{'code': '200000'"
...
token= '2neAiuYvAU61ZDXANAGAsiL4-iAExhsBXZxftpOeh_55i3Ysy2q2LEsEWU64mdzUOPusi34M_wGoSf7iNyEWJwYVXOGC3xJBUdb4jIyh6X2g8Vjoy_QhWtiYB9J6i9GjsxUuhPw3BlrzazF6ghq4LwmVWQJ2K9vOMKqeneRD0WE=.Bt7-iLK8o4ega8W5qqkQIQ=='
header="Authorization: BEARER " + str(token)
# ws = create_connection(url, header) # TypeError: an integer is required (got type str)
